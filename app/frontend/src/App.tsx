...
import {
  CustomerDetails,
  getCustomerDetails,
} from "./utils/CallAuthenicationDetails";
import {
  AgentPageData,
  getAgentPageData,
} from "./components/Agent/InitAgentData";
    ...
    switch (page) {
      ...
      case "Customer": {
        if (customerData !== undefined) {
          const createGroupId = (): GroupLocator => ({
            groupId: customerData.CallId,
          });
          ...
          return (
            <CallScreen
              ...
              userId={ACSUserid}
              displayName={displayName}
              callLocator={customerCallLocator}
            />
          );
        } else {
          return <h3>Initializing...</h3>;
